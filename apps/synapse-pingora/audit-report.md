...
**Generated:** 2026-02-10T19:00:37Z
...
src/tui.rs:27:22: warning: unused import: `MetricsRegistry`
...
src/tui.rs:46:5: warning: fields `block_log` and `start_time` are never read
...
src/metrics.rs:872:9: warning: clamp-like pattern without using clamp function: help: replace with clamp: `pct = pct.clamp(0.0, 1.0);`
...
src/actor/manager.rs:365:31: warning: very complex type used. Consider factoring parts into `type` definitions
src/actor/manager.rs:843:12: warning: manual implementation of `.is_multiple_of()`: help: replace with: `!count.is_multiple_of(100)`
...
src/crawler/detector.rs:236:25: warning: very complex type used. Consider factoring parts into `type` definitions
src/crawler/detector.rs:238:25: warning: very complex type used. Consider factoring parts into `type` definitions
src/crawler/detector.rs:300:9: warning: field assignment outside of initializer for an instance created with Default::default()
src/crawler/detector.rs:421:72: warning: this `if` has identical blocks
